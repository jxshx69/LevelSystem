...
diag_log "===========================================";
diag_log "[LevelSystem Network] levelSystemZombieKill received!";
diag_log format["  XP Amount: %1", _xpAmount];
diag_log format["  Zombie Name: %1", _zombieName];
diag_log "===========================================";

// Award XP
[_xpAmount, format["Zombie (%1)", _zombieName]] call ExileClient_LevelSystem_addXP;

diag_log format["[LevelSystem] Zombie kill XP awarded: %1 XP for %2", _xpAmount, _zombieName];
