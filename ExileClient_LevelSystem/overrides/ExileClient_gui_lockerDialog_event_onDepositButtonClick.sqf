 ...
 * MODIFIED: Dynamic locker limit based on level
 */
 
private["_display","_amountInput","_alphabet","_forbiddenCharacter","_playerMoney","_depositAmount","_lockerLimit","_lockerAmount","_newLockerAmount","_playerLevel"];
...
try
{
	...
	{
		throw format ["Your locker can only hold %1 pop tabs (Level %2).", _lockerLimit, _playerLevel];
	};
